...
//     _messages = sp.getMessages(poolName, _idStart, _idEnd, 100).map((e) {
//       var id = 0;
...
//               id: e.id.toString(),
//               author: types.User(id: e.author),
//               text: "unsupported type ${e.contentType}");
//       }
//     }).toList();
//   }
...
//     _user = types.User(id: sp.getSelfId(), firstName: p.self.nick);
//   }
...
//     var m = sp.Message();
//     m.author = sp.getSelfId();
//     m.content = message.text;
//     m.contentType = "text/html";
//     var id = sp.postMessage(_poolName, m);
